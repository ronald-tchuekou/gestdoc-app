<div class="tab-pane active" id="user-tab-root" role="tabpanel" aria-labelledby="user-pill-root" aria-expanded="true">
    <div class="card">
        <div class="card-header d-flex justify-content-between p-0 pt-2 px-1">
            <h5 class="font-weight-bolder">Liste de tous les super users</h5>
            <div class="d-flex justify-content-between">
                <div class="text-md-center">
                    <a href="/{{strtolower(Auth::user()->role)}}/root-account/add" class="btn btn-primary text-white ml-1 text-nowrap btn-sm" style="font-size: 1rem;">
        ...
        <div class="card-body">
            <table class="table table-striped table-bordered table-responsive" style="width:100%" id="account_table_root">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/{{strtolower(Auth::user()->role)}}/root-accueil/{{$agent->id}}/details"  class="dropdown-item" style="padding: 7px 9px;">
                                        <i class="feather icon-file-text" style="font-size: 1.5rem;"></i>
                                        &nbsp;&nbsp;&nbsp;Details
                                    </a>
                                    <a href="/{{strtolower(Auth::user()->role)}}/root-account/{{$agent->id}}" class="dropdown-item" style="padding: 7px 9px;">
