            ...
            <div class="row px-1" style="padding-top: 4px; padding-bottom: 4px;">
                ...
                <div class="col-4">
                    <li class="d-inline-block mr-2">
                        <fieldset>
                            <div class="vs-radio-con">
                                <input type="radio" name="status" @if($personne->status == 'Marié') checked @endif value="Marié">
                                <span class="vs-radio">
                                    <span class="vs-radio--border"></span>
                                    <span class="vs-radio--circle"></span>
                                </span>
                ...
                <div class="col-4">
                    <li class="d-inline-block mr-2">
                        <fieldset>
                            <div class="vs-radio-con">
                                <input type="radio" name="status" @if($personne->status == 'Célibataire') checked @endif value="Célibataire">
                                <span class="vs-radio">
                                    <span class="vs-radio--border"></span>
                                    <span class="vs-radio--circle"></span>
                                </span>
