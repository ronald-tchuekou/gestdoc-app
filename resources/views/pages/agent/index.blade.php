...
@include('pages.agent.couriers.modify')

@include('pages.agent.couriers.finish')

@include('pages.agent.couriers.reject')

@include('pages.agent.couriers.valide')
