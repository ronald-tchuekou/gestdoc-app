...
<div class="card">
    <div class="card-header d-flex justify-content-between flex-nowrap p-0 pt-2 px-1">
        <h5 class="font-weight-bolder sorting_1 ellipsize" style="min-width: 250px;">Liste de tous le personnel du service d'accueil</h5>
        <div class="d-flex justify-content-between">
            <div class="text-md-center">
                <a href="/{{strtolower(Auth::user()->role)}}/accueil-personnel/add" class="btn btn-primary text-white ml-1 text-nowrap btn-sm" style="font-size: 1rem;">
    ...
    <div class="card-body">
        <table class="table table-striped table-bordered table-responsive" style="width:100%" id="account_table_accueil">
            ...
            <tbody>
                @forelse($accueil_peronals as $agent)
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="/{{strtolower(Auth::user()->role)}}/accueil-personnel/{{$agent->id}}/details"  class="dropdown-item" style="padding: 7px 9px;">
                                    <i class="feather icon-file-text" style="font-size: 1.5rem;"></i>
                                    &nbsp;&nbsp;&nbsp;Details
                                </a>
                                <a href="/{{strtolower(Auth::user()->role)}}/accueil-personnel/{{$agent->id}}" class="dropdown-item" style="padding: 7px 9px;">
                                    <i class="feather icon-edit-2" style="font-size: 1.5rem;"></i>
                                    &nbsp;&nbsp;&nbsp;Edit
                                </a>
                                <a href="/appadmin/root-account/{{$agent->id}}/delete" class="dropdown-item" style="padding: 7px 9px;">
